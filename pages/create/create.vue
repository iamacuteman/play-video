<template>
	<view>
		<view class="bg-light position-relative" style="height: 350rpx;" hover-class="bg-hover-light" @tap="upload">
			...
			<view class="position-absolute left-0 right-0 bottom-0 top-0  flex flex-column align-center justify-center"
		...
		<picker mode="selector" :range="range" @change="change">
			<form-item label="分类" rightIcon>
				<input type="text" v-model="form.category" placeholder="请选择分类" placeholder-class="text-light-muted"
		...
		<view class="py-2 px-3">
			<main-big-button @tap="sumbit">发布</main-big-button>
		</view>
		<!-- #endif -->
